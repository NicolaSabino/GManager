...
--
-- Host: localhost
-- Creato il: Feb 11, 2016 alle 10:42
...
CREATE TABLE `Fornitore` (
  ...
  `CEO` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
...
INSERT INTO `Fornitore` (`Nome`, `Indirizzo`, `Telefono`, `Mail`, `CEO`) VALUES
('azienda', 'via delle driadi 10', '3895539050', 'spa@esempio.it', 'Nicola Sabino');
...
CREATE TABLE `Ordine` (
  ...
  `Pezzo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `DataOrdine` date NOT NULL,
  `Attivita` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
